...
//
// The demo runner's own client, speaking the request/response shape Masumi
// proposed for MAS-596 P0 item 1 to the in-process mock (cosign-mock.ts). The
// production path speaks the frozen Exchain contract instead:
// src/smart-wallet/cosign-client.ts. The co-signer only ever adds vkey witnesses
