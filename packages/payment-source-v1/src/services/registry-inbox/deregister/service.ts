...
// TODO(v1-package-boundary): move lock-and-query-inbox-agent-registration-request, contract-generator, blockchain-error-interpreter, agent-identifier, utxo to @masumi/payment-core
