 ...
 */
export const getRegistryA2A = <ThrowOnError extends boolean = false>(options: Options<GetRegistryA2aData, ThrowOnError>): RequestResult<GetRegistryA2aResponses, GetRegistryA2aErrors, ThrowOnError> => (options.client ?? client).get<GetRegistryA2aResponses, GetRegistryA2aErrors, ThrowOnError>({
 ...
 */
export const postRegistryA2A = <ThrowOnError extends boolean = false>(options?: Options<PostRegistryA2aData, ThrowOnError>): RequestResult<PostRegistryA2aResponses, PostRegistryA2aErrors, ThrowOnError> => (options?.client ?? client).post<PostRegistryA2aResponses, PostRegistryA2aErrors, ThrowOnError>({
