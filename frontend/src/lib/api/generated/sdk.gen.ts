...
import type {
  ...
  PostRetryExternalActionData,
  PostRetryExternalActionResponse,
  PostRetryExternalActionError,
  GetPurchaseData,
  GetPurchaseResponse,
  PostPurchaseData,
 ...
 */
export const postRetryExternalAction = <ThrowOnError extends boolean = false>(
  options?: Options<PostRetryExternalActionData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).post<
    PostRetryExternalActionResponse,
    PostRetryExternalActionError,
