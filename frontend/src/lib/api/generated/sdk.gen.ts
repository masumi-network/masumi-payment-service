 ...
 */
export const getBalance = <ThrowOnError extends boolean = false>(options: Options<GetBalanceData, ThrowOnError>) => (options.client ?? client).get<GetBalanceResponses, unknown, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
    url: '/balance',
    ...options
