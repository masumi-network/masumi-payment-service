...
/**
 * Create a new x402 purchase request and get an unsigned transaction. (+PAY access required)
 *
 ...
 */
export const postPurchaseX402 = <ThrowOnError extends boolean = false>(options?: Options<PostPurchaseX402Data, ThrowOnError>) => (options?.client ?? client).post<PostPurchaseX402Responses, PostPurchaseX402Errors, ThrowOnError>({
    responseTransformer: postPurchaseX402ResponseTransformer,
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
    url: '/purchase/x402',
    ...options,
