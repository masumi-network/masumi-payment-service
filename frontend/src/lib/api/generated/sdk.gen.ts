 ...
 */
export const getPurchasePurchaseEarnings = <ThrowOnError extends boolean = false>(options: Options<GetPurchasePurchaseEarningsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPurchasePurchaseEarningsResponse, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'token',
 ...
 */
export const getPaymentPaymentEarnings = <ThrowOnError extends boolean = false>(options: Options<GetPaymentPaymentEarningsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPaymentPaymentEarningsResponse, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'token',
