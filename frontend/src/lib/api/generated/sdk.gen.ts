...
import type {
  ...
  GetRegistryCountData,
  GetRegistryCountResponse,
 ...
 */
export const getPaymentCount = <ThrowOnError extends boolean = false>(
  options: Options<GetPaymentCountData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetPaymentCountResponse,
    unknown,
 ...
 */
export const getPurchaseCount = <ThrowOnError extends boolean = false>(
  options: Options<GetPurchaseCountData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetPurchaseCountResponse,
    unknown,
 ...
 */
export const getRegistryCount = <ThrowOnError extends boolean = false>(
  options: Options<GetRegistryCountData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetRegistryCountResponse,
    unknown,
