 ...
 */
export const postInvoiceSignature = <ThrowOnError extends boolean = false>(options?: Options<PostInvoiceSignatureData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostInvoiceSignatureResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
