 ...
 */
export const getWalletTransferFunds = <ThrowOnError extends boolean = false>(options?: Options<GetWalletTransferFundsData, ThrowOnError>) => (options?.client ?? client).get<GetWalletTransferFundsResponses, GetWalletTransferFundsErrors, ThrowOnError>({
 ...
 */
export const postWalletTransferFunds = <ThrowOnError extends boolean = false>(options?: Options<PostWalletTransferFundsData, ThrowOnError>) => (options?.client ?? client).post<PostWalletTransferFundsResponses, PostWalletTransferFundsErrors, ThrowOnError>({
