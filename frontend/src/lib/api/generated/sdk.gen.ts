...
export const postSwap = <ThrowOnError extends boolean = false>(options?: Options<PostSwapData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostSwapResponse, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'token',
