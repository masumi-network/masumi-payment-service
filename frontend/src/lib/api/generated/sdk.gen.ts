 ...
 */
export const postInvoiceSignature = <ThrowOnError extends boolean = false>(options?: Options<PostInvoiceSignatureData, ThrowOnError>) => (options?.client ?? client).post<PostInvoiceSignatureResponses, unknown, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
 ...
 */
export const postInvoiceSignatureMonthly = <ThrowOnError extends boolean = false>(options?: Options<PostInvoiceSignatureMonthlyData, ThrowOnError>) => (options?.client ?? client).post<PostInvoiceSignatureMonthlyResponses, unknown, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
