 ...
 */
export const postRetryExternalAction = <ThrowOnError extends boolean = false>(options?: Options<PostRetryExternalActionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostRetryExternalActionResponse, PostRetryExternalActionError, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'token',
