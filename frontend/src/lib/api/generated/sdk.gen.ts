...
/**
 * Mint a read token for the embedded Exchain page. (admin access required)
 *
 ...
 */
export const postExchainReadToken = <ThrowOnError extends boolean = false>(options?: Options<PostExchainReadTokenData, ThrowOnError>): RequestResult<PostExchainReadTokenResponses, PostExchainReadTokenErrors, ThrowOnError> => (options?.client ?? client).post<PostExchainReadTokenResponses, PostExchainReadTokenErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
