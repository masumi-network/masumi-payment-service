 ...
 */
export const getRegistryA2A = <ThrowOnError extends boolean = false>(options: Options<GetRegistryA2aData, ThrowOnError>) => (options.client ?? client).get<GetRegistryA2aResponses, unknown, ThrowOnError>({
