 ...
 */
export const getWalletFund = <ThrowOnError extends boolean = false>(options?: Options<GetWalletFundData, ThrowOnError>) => (options?.client ?? client).get<GetWalletFundResponses, GetWalletFundErrors, ThrowOnError>({
    responseTransformer: getWalletFundResponseTransformer,
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
    url: '/wallet/fund',
    ...options
...
/**
 * Request a fund transfer from a wallet. (admin access required)
 *
 ...
 */
export const postWalletFund = <ThrowOnError extends boolean = false>(options?: Options<PostWalletFundData, ThrowOnError>) => (options?.client ?? client).post<PostWalletFundResponses, PostWalletFundErrors, ThrowOnError>({
    responseTransformer: postWalletFundResponseTransformer,
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
    url: '/wallet/fund',
    ...options,
