 ...
 */
export const getPurchaseEarnings = <ThrowOnError extends boolean = false>(options: Options<GetPurchaseEarningsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPurchaseEarningsResponse, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'token',
 ...
 */
export const getPaymentEarnings = <ThrowOnError extends boolean = false>(options: Options<GetPaymentEarningsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPaymentEarningsResponse, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'token',
