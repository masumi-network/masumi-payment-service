...
import type {
  ...
  GetPurchasePurchaseEarningsData,
  GetPurchasePurchaseEarningsResponse,
  GetPaymentPaymentEarningsData,
  GetPaymentPaymentEarningsResponse,
 ...
 */
export const getPurchasePurchaseEarnings = <
  ThrowOnError extends boolean = false,
>(
  options: Options<GetPurchasePurchaseEarningsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetPurchasePurchaseEarningsResponse,
    unknown,
 ...
 */
export const getPaymentPaymentEarnings = <ThrowOnError extends boolean = false>(
  options: Options<GetPaymentPaymentEarningsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetPaymentPaymentEarningsResponse,
    unknown,
