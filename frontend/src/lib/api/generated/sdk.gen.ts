...
/**
 * Stop guarding a purchasing wallet. (admin access required)
 *
 ...
 */
export const deleteWalletGuard = <ThrowOnError extends boolean = false>(options?: Options<DeleteWalletGuardData, ThrowOnError>): RequestResult<DeleteWalletGuardResponses, DeleteWalletGuardErrors, ThrowOnError> => (options?.client ?? client).delete<DeleteWalletGuardResponses, DeleteWalletGuardErrors, ThrowOnError>({
    responseTransformer: deleteWalletGuardResponseTransformer,
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
    url: '/wallet/guard',
    ...options,
...
/**
 * Guard a purchasing wallet. (admin access required)
 *
 ...
 */
export const postWalletGuard = <ThrowOnError extends boolean = false>(options?: Options<PostWalletGuardData, ThrowOnError>): RequestResult<PostWalletGuardResponses, PostWalletGuardErrors, ThrowOnError> => (options?.client ?? client).post<PostWalletGuardResponses, PostWalletGuardErrors, ThrowOnError>({
    responseTransformer: postWalletGuardResponseTransformer,
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
    url: '/wallet/guard',
    ...options,
...
/**
 * Read-only co-sign page for a guarded wallet. (admin access required)
 *
 ...
 */
export const postWalletGuardReadToken = <ThrowOnError extends boolean = false>(options?: Options<PostWalletGuardReadTokenData, ThrowOnError>): RequestResult<PostWalletGuardReadTokenResponses, PostWalletGuardReadTokenErrors, ThrowOnError> => (options?.client ?? client).post<PostWalletGuardReadTokenResponses, PostWalletGuardReadTokenErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'token', type: 'apiKey' }],
