    ...
    data: {
      Payments: Array<{
        ...
        WithdrawnForBuyer: Array<{
          ...
          amount: string;
          /**
           * Asset policy id + asset name concatenated.
           */
          unit: string;
        }>;
        /**
...
export type PostPaymentData = {
  body?: {
    ...
    RequestedFunds?: Array<{
      /**
       * Amount of the asset in smallest unit
       */
      amount: string;
      /**
       * Asset policy id + asset name concatenated.
  ...
  200: {
    data: {
      ...
      PaymentSource: {
        ...
        id: string;
        /**
         * The Cardano network (Mainnet, Preprod)
         */
        network: 'Preprod' | 'Mainnet';
        /**
         * Address of the smart contract managing this payment
  ...
  200: {
    ...
    data: {
      Purchases: Array<{
        ...
        /**
         * List of assets and amounts paid by the buyer
         */
        PaidFunds: Array<{
          /**
           * Amount of the asset paid
           */
          amount: string;
          /**
           * Asset policy id + asset name concatenated. Empty string for ADA/lovelace
...
export type PostPurchaseErrors = {
  ...
  409: {
    ...
    object: {
      ...
      resultHash: string;
      /**
       * SHA256 hash of the input data for the purchase
       */
      inputHash: string;
      /**
       * Current state of the purchase on the blockchain. Null if not yet on-chain
