export const TOOLTIP_TEXTS = {
  ...
  BUYING_WALLET_TYPE:
    'A buying wallet pays for AI agent services on Masumi Network. When you use an AI service (e.g., data analysis for 10 ADA), funds are automatically sent from your wallet to the provider. Keep it loaded with ADA or USDM to make purchases.',
  SELLING_WALLET_TYPE:
    'A selling wallet receives money when customers use your AI services (e.g., 5 ADA for image generation). Payments go here automatically, then you can move them to your main wallet.',
