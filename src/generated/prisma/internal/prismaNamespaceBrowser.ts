...
export const RegistryRequestScalarFieldEnum = {
  ...
  a2aProtocolVersions: 'a2aProtocolVersions',
  a2aAgentVersion: 'a2aAgentVersion',
  a2aDefaultInputModes: 'a2aDefaultInputModes',
  a2aDefaultOutputModes: 'a2aDefaultOutputModes',
  a2aProviderName: 'a2aProviderName',
  a2aProviderUrl: 'a2aProviderUrl',
  a2aDocumentationUrl: 'a2aDocumentationUrl',
  a2aIconUrl: 'a2aIconUrl',
  a2aCapabilitiesStreaming: 'a2aCapabilitiesStreaming',
  a2aCapabilitiesPushNotifications: 'a2aCapabilitiesPushNotifications',
