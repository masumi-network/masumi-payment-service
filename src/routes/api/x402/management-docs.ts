...
export function registerX402ManagementPaths({ registry, apiKeyAuth }: SwaggerRegistrarContext) {
	...
	registry.registerPath({
		...
		summary: 'Update a managed x402 EVM wallet. (pay access required; non-admin keys only their own)',
		tags: ['x402'],
		security: secured,
		request: {
			body: {
	...
	registry.registerPath({
		...
		summary: 'Count managed x402 wallets. (pay access required; non-admin keys count only their own)',
		tags: ['x402'],
		security: secured,
	...
	registry.registerPath({
		...
		summary: 'Count x402 payment attempts. (pay access required; non-admin keys count only their own)',
		tags: ['x402'],
		security: secured,
	...
	registry.registerPath({
		...
		summary: 'Count x402 settlements. (pay access required; non-admin keys count only their own)',
		tags: ['x402'],
		security: secured,
