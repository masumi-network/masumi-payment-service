    ...
    z.object({
      ...
      WithdrawnForBuyer: z
        .array(
          z.object({
            ...
            unit: z
              .string()
              .describe('Asset policy id + asset name concatenated.'),
          }),
        )
      ...
      BuyerWallet: z
        .object({
          ...
          walletVkey: z
            .string()
            .describe('Payment key hash of the buyer wallet'),
        })
        .nullable()
        .describe(
    ...
    .array(
      z.object({
        amount: z
          .string()
          .max(25)
          .describe('Amount of the asset in smallest unit'),
        unit: z
          .string()
          .max(150)
          .describe('Asset policy id + asset name concatenated.'),
...
export const createPaymentSchemaOutput = z.object({
  ...
  inputHash: z
    .string()
    .describe('SHA256 hash of the input data for the payment '),
  resultHash: z
    .string()
    .describe(
      'SHA256 hash of the result submitted by the seller. Empty string if not yet submitted',
    ),
  onChainState: z
    .nativeEnum(OnChainState)
    .nullable()
  ...
  WithdrawnForSeller: z
    .array(
      z.object({
        amount: z.string().describe('Amount of the asset withdrawn'),
        unit: z.string().describe('Asset policy id + asset name concatenated.'),
      }),
    )
    .describe('List of assets and amounts withdrawn for the seller'),
  WithdrawnForBuyer: z
  ...
  PaymentSource: z
    .object({
      ...
      network: z
        .nativeEnum(Network)
        .describe('The Cardano network (Mainnet, Preprod)'),
      smartContractAddress: z
        .string()
        .describe('Address of the smart contract managing this payment'),
      policyId: z
