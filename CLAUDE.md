...
- V2 code paths (`packages/payment-source-v2`) use
  `@meshsdk/core@1.9.0-beta.103` and `@meshsdk/core-cst@1.9.1`
  (core bumped from beta.102 for Hydra 2.2.0; core-cst on stable 1.9.1 —
  V2 address derivation verified byte-identical across beta.102→1.9.1,
  and tx serialization still runs on core's own nested beta.103 cst).
